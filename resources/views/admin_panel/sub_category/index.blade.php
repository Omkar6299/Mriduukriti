    ...
    <div class="container">
        <div class="row">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('sub_category.create') }}" class="btn btn-primary">
                    <i class="material-symbols-rounded align-middle">add</i> Add Sub Category
                </a>
            </div>
                            ...
                            <table class="table  align-middle mb-0" id="dataTables">
                                <thead class="bg-gradient-primary ">
                                    <tr>
                                        ...
                                        <th class="text-white">Parent Category</th>
