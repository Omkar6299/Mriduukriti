        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form class="multisteps-form__form" action="{{ route('sub_category.store') }}" method="POST"
                                ...
                                <div class="multisteps-form__content">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="input-group input-group-dynamic">
                                                ...
                                                <select class="form-control" name="category_id" id="choices-category">
                                                    <option selected disabled>Select Category<span
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-success">
                                            <i class="material-symbols-rounded align-middle">check_circle</i> Save
                                        </button>
                                    </div>
                                </div>
                            </div>
