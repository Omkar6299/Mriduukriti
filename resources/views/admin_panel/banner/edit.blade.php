        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form class="multisteps-form__form" action="{{ route('banners.update', $banner->id) }}" method="POST"
                                ...
                                <div class="multisteps-form__content">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12 col-sm-12 mb-3">
                                            <div class="input-group input-group-dynamic">
                                                ...
                                                <input class="multisteps-form__input form-control" value="{{ old('link', $banner->link??'')}}" type="link"
                                                    name="link" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <textarea id="edit-description" name="description">{{ old('description', $banner->paragraph??'')}}</textarea>
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <div id="drop-area"
                                                ...
                                                <div id="imagePreviewContainer"
                                                    class="mt-3 {{ $banner->bannner ? '' : 'd-none' }} position-relative d-inline-block">
                                                    <img id="imagePreview"
                                                        src="{{ $banner->bannner ? asset($banner->bannner) : '#' }}"
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-success">
                                            <i class="material-symbols-rounded align-middle">check_circle</i> Update Banner
                                        </button>
                                    </div>
                                </div>
                            </div>
